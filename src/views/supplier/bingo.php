...
<body>
    <div class="mobile-display">
        ...
        <div class="imgGigante bingoimg">
            <h1>Bingo</h1>
            <p class="textPresentacion">
            ¡Bienvenido a la emocionante aventura del bingo! ¿Estás listo para sumergirte en el mundo del bingo, 
            donde cada número puede cambiar tu destino?
            </p>
